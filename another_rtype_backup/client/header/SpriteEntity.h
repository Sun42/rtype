...
enum typeShip	{PLAYER1, PLAYER2, PLAYER3, PLAYER4, MONSTER1, MONSTER2, MONSTER3, MONSTER4, BOSS1, BOSS2};
enum typeWeapon	{WEAPON1, WEAPON2, WEAPON3, WEAPON4};
...
class	SpriteEntity
{
 public:
  ...
  bool				isPlayer() const;
  bool				checkCollision(SpriteEntity* rhs);
