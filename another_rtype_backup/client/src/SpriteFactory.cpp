...
# include "Monster2.h"	//Ships
//# include "Monster3.h"	//Ships
//# include "Monster4.h"	//Ships
# include "Boss1.h"	//Ships
//# include "Boss2.h"	//Ships
...
# include "Weapon3.h"	//Weapons
# include "Weapon4.h"	//Weapons
...
SpriteFactory::SpriteFactory(): _ptrMapShip(), _ptrMapWeapon(), _ptrMapDecor()
{
  ...
  this->_ptrMapShip[MONSTER2] = &::BuilderMonster2;
  //this->_ptrMapShip[MONSTER3] = &::BuilderMonster3;
  this->_ptrMapShip[BOSS1] = &::BuilderBoss1;
  this->_ptrMapWeapon[WEAPON1] = &::BuilderWeapon1;
  this->_ptrMapWeapon[WEAPON2] = &::BuilderWeapon2;
  this->_ptrMapWeapon[WEAPON3] = &::BuilderWeapon3;
  this->_ptrMapWeapon[WEAPON4] = &::BuilderWeapon4;
